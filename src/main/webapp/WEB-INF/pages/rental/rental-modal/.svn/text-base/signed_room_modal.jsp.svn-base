...
<div class="modal fade bs-example-modal-lg" id="signedRoomModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <form id="addRentContractForm">
                    <table style="width: 100%;text-align: center">
                        ...
                        <tr>
                            ...
                            <td class="text-info"><span class="house-info"></span>
                                <input type="text" hidden name="roomId">
                                <input type="text" name="contractType" hidden value="租房">
                            </td>
                        </tr>
                        <tr>
                            <td>房间地址</td>
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn btn-primary" onclick="addRentContract()">保存</a>
            </div>
        </div>
    </div>
</div>