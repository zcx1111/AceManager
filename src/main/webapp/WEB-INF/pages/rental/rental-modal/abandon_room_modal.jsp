...
--%>
<div class="modal fade bs-example-modal-lg" id="abandonRoomModal" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel"
     aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="abandonRoomForm">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td>房间信息：<span class="house-info text-info"></span></td>
                            <td>房间地址：<span class="house-address text-info"></span></td>
                        </tr>
                        <tr>
                            <td>租客姓名：<span class="text-info clientele-name"></span></td>
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn btn-primary" onclick="abandonContract($('#abandonRoomForm'))">确定</a>
            </div>
        </div>
    </div>
</div>