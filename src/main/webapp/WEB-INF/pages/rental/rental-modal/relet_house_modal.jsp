...
<div class="modal fade bs-example-modal-lg" id="reletHouseModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reletHouseContractForm">
                    <table id="reletHouseTable" style="width: 100%;text-align: center">
                        ...
                        <tr>
                            ...
                            <input type="text" hidden name="houseId" class="houseId"></td>
                        </tr>
                        <tr>
                            <td>房源地址</td>
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn btn-primary" onclick="reletContract($('#reletHouseContractForm'))">保存</a>
            </div>
        </div>
    </div>
</div>