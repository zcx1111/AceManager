...
/*javascript
了解了js中Date对象的基本用法，接下来就是代码实现部分了，整体思路是这样的：定义一个全局的dateObj变量，
用来记录表格中需要显示的 年月信息。 标题中的内容根据dateObj中取，表格中的日期则中dateObj中取到年月对应的1号的所有信息，
即可确定1号在表格第一行的位置，以此倒推上个月 最后几天的数据、正推本月和下个月的数据。
具体步骤：
