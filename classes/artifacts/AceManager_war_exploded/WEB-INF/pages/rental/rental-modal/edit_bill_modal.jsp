...
<div class="modal fade bs-example-modal-lg" id="editBillModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3>账单编辑<span class="text-info" name="bill-id"></span></h3>
            </div>
            <form id="updateBillAll" method="get">
                <div class="modal-body">
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td>业主姓名</td>
                            <td><input type="text" style="width: 30%;" class="form-control" id="update_Name"
                                       name="bill[0].transactionObjectName" value="">
                            </td>
                        </tr>
                        <tr>
                            <td>账单周期</td>
                            <td>
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" id="edit_bill_startTime" class="form-control Wdate"
                                               name="bill[0].billStartDate"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" id="edit_bill_endTime" class="form-control Wdate"
                                               name="bill[0].billEndDate"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="">
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" id="edit_bill_receiptDate" class="form-control Wdate"
                                               name="bill[0].receiptDate"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="2017-07-19">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"><textarea style="resize: none" name="bill[0].billNote"
                        ...
                        <tr class="tab_tr">
                            <td><input type="text" style="display: none;" class="form-control" id="edit_billId"
                                       name="bill[0].id" value=""></td>
                        </tr>
                    </table>
                </div>
            </form>
            <div class="modal-footer">
                ...
                <a href="#" onclick="updateBill()" class="btn btn-primary" data-dismiss="modal">保存</a>
            </div>
        </div>
    </div>
</div>